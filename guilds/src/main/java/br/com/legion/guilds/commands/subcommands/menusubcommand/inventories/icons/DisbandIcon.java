...
public class DisbandIcon extends MenuIcon {
    ...
    public DisbandIcon(User user, Supplier<CustomInventory> back) {
        super(user, back);
    }
    ...
    public ItemStack getIcon() {
        ItemBuilder builder = ItemBuilder.of(Material.DARK_OAK_DOOR)
                .name("&cDesfazer Guilda")
                .lore(
                        "&7Ao clicar neste ícone a sua",
                        "&7guilda será desfeita.",
                        "",
                        "Dica: Use /guilda desfazer",
                        "&cClique para desfazer a guilda."
                );
    ...
    public Runnable getRunnable() {
        return () -> {
            Bukkit.getPlayerExact(user.getName()).performCommand("guilda desfazer");
        };
    }
