...
public class GloryPointsDefineSubCommand extends CustomCommand {

    public GloryPointsDefineSubCommand() {
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        GloryPointsAPI.define(offlinePlayer.getName(), value);

        sender.sendMessage(
                String.format(
                        "§eVocê definiu §f%s pontos de glória §epara §f%s§e.",
