...
public class EconomyRemoveSubCommand extends CustomCommand {

    public EconomyRemoveSubCommand() {
        super("remove", CommandRestriction.CONSOLE_AND_IN_GAME, "remover");

        registerArgument(new NickArgument("nome", "Nome do destinatário."));
        registerArgument(new Argument("quantia", "Quantia de coins."));
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        EconomyAPI.withdraw(null, offlinePlayer.getName(), value);

        sender.sendMessage(
                String.format(
                        "§eVocê removeu §f%s coins §ede §f%s§e.",
